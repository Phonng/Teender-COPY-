...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="choose?userID=${info.nickname}" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Tìm bạn</a>
    <a href="chat" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Nhắn tin</a>
    <a href="chatwithstrangers.jsp" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Chat với người lạ</a>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px; min-height: 300px">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-third">
        <p>Sơn</p>
        <img src="uploads/teender (11).jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:165px; height:165px">
      </div>
      <div class="w3-third">
        <p>Ngọc Anh</p>
        <img src="uploads/teender (12).jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:165px; height:165px">
      </div>
      <div class="w3-third">
        <p>Phong</p>
        <img src="uploads/teender (10).jpg" class="w3-round" alt="Random Name" style="width:165px; height:165px">
      </div>
    </div>
  </div>
    ...
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          <img src="uploads/teender (3).jpg" alt="" style="width:100%; height: 250px" class="w3-hover-opacity"/>
          <div class="w3-container w3-white">
            <p><b>Hà</b></p>
            <p class="w3-opacity">Fri 27 Nov 2016</p>
            <p>Teender là ứng dụng tốt nhất tôi từng dùng</p>
          </div>
        </div>
        <div class="w3-third w3-margin-bottom">
          <img src="uploads/teender (7).jpg" alt="" style="width:100%; height: 250px" class="w3-hover-opacity"/>
          <div class="w3-container w3-white">
            <p><b>Mai</b></p>
            <p class="w3-opacity">Sat 28 Nov 2016</p>
            <p>Ứng dụng rất tiện lợi.Có nhiều chức năng và giao diện rất đẹp</p>
          </div>
        </div>
        <div class="w3-third w3-margin-bottom">
          <img src="uploads/teender (9).jpg" alt="" style="width:100%; height: 250px" class="w3-hover-opacity"/>
          <div class="w3-container w3-white">
            <p><b>Lan</b></p>
